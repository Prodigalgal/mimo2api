...
from .account_service import validate_and_save as _validate_and_save  # noqa: E402
...
# ─── 注册/临时邮箱/批量/续期 → register_routes.py ───
from .register_routes import (  # noqa: E402,F401
    router as register_router,
    _renew_one_account,
    _mail_cfg_from_settings,
)
